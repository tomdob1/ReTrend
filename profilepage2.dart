...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<dynamic> getData() async {
    ...
    final DocumentReference document =   Firestore.instance.collection("preferences").document('1');
